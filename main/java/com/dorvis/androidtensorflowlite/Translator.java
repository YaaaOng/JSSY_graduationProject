...
public class Translator extends AppCompatActivity {
    ...
    //EditText etSource;//입력받는거 뭘로 받을지 생각 recognitions.get(
...
//이건 나중에...
    ...
    public class NaverTranslateTask extends AsyncTask<String, Void, String> {
        ...
        //Naver
        String clientId = "jTkQek6XVYRcCCZ8gckD";//애플리케이션 클라이언트 아이디값";
        String clientSecret = "08jmtJD2zO";//애플리케이션 클라이언트 시크릿값";
...
//번역결과를 텍스트뷰에 넣는다.
            ...
            //activity_object_detect_result 에서 끌어다쓰기
        }
